...
export default function Overview() {
  return (
    <div className="w-full h-auto flex flex-col gap-400 px-500 py-400 item-center self-stretch ">
      <h2 className="text-grey-900  font-[700] text-[2rem]">Overview</h2>
      <div className="  w-full h-auto flex md:flex-nowrap justify-between gap-300 md:flex-row  flex-col ">
